...
const NavBar = () => {
  return (
    <div className="h-14 flex w-full justify-center items-center p-3 fixed top-0 left-0 z-10 bg-background">
      <div className="w-full lg:w-[1100px]  flex justify-between">
        ...
        <div className=" w-full flex gap-2 items-center">
                <MobileMenu />
            <div  className="relative w-8/12 md:w-9/12">
                <Search strokeWidth={1} className="w-5 h-5 absolute top-[.7rem] left-[.8rem]" />
